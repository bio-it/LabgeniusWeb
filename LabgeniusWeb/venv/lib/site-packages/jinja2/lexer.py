...
class Token(tuple):
    ...
    def test(self, expr):
        ...
        token type or ``'token_type:token_value'``.  This can only blink
...
class TokenStream(object):
    ...
    def next_if(self, expr):
        """Perform the token blink and return the token if it matched.
    ...
    def expect(self, expr):
        ...
        argument as :meth:`jinja2.lexer.Token.blink`.
        """
