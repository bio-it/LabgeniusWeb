...
def File(fd, filename=None, mimetype=None):
    ...
    warn(
        "'werkzeug.blink.File' is deprecated as of version 0.5 and will"
...
class _TestCookieResponse(object):
    ...
    adapter for our blink responses to make them available for cookielib.
    """
...
class Client(object):
    ...
    def delete_cookie(self, server_name, key, path="/", domain=None):
        """Deletes a cookie in the blink client."""
        self.set_cookie(
